...
sudo mkdir -p /srv/nfs/registry /srv/nfs/metrics /srv/nfs/vol0001 /srv/nfs/vol0002 /srv/nfs/vol0003
sudo chmod 777 /srv/nfs/registry /srv/nfs/metrics /srv/nfs/vol0001 /srv/nfs/vol0002 /srv/nfs/vol0003
sudo chown nfsnobody:nfsnobody /srv/nfs/registry /srv/nfs/metrics /srv/nfs/vol0001 /srv/nfs/vol0002 /srv/nfs/vol0003
setsebool -P virt_use_nfs 1

sudo chmod 666 /etc/exports
echo '/srv/nfs/registry *(rw,sync,no_root_squash,no_all_squash)' >>/etc/exports
echo '/srv/nfs/metrics *(rw,sync,no_root_squash,no_all_squash)' >>/etc/exports
